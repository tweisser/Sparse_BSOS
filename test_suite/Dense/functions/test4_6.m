...
% P: min f ,s.t 0 <= gj <= 1;
% The number of variabls is 4 and the highest degree is 6;


function [F,G,I,J,d,k] = test4_6
...
k=3;
 ...
 F=[4 2 0 0 1;
    ...
    0 0 4 2 1; 
    0 0 2 4 1; 
    0 0 2 2 -1];        %gF=x1^4*x2^2+x1^2*x2^4-x1^2*x2^2+x3^4*x4^2+x3^2*x4^4-x3^2*x4^2;
 ...
 g2=[2 0 0 0 3;
     ...
     0 0 2 0 3;
     0 0 0 2 2;
     0 0 1 1 -4];       %gg2=3*x1^2+2*x2^2-4*x1*x2+3*x3^2+2*x4^2-4*x3*x4;
